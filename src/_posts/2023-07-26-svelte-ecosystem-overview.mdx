...
img: '/assets/img/svelte-machine.png'
imgAttribution: 'Intro image from <a href="https://svelte.dev">svelte.dev</a>'
---
...
I've spent time researching and analyzing, I hope this post can help you quickly digest the pros and cons.

At first glance, based solely on the numbers, it might seem like the react ecosystem is far superior. There is an overwhelming number of npm packages, it's stewarded by a big tech company, and seems like it's the obvious choice.
