...
<Box
  sx={{
    ...
    paddingLeft: [3, 6, 6],
    backgroundImage:
      'url(https://images.unsplash.com/photo-1500687957377-1980ef9a86d2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80)',
