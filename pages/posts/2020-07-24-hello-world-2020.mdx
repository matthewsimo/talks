...
The most obvious way here is to make sure I have a good "about page" that showcases past projects and select clients - I'll be working on that too as time allows. The other way, is to write technical posts where I can share whatever cool new technique I've come across or used on a project. I'd like to mix in some non-technical articles as well, I've learned a lot leading teams and that content could be useful to some folks.
...
<Box sx={{ paddingTop: [3, 4, 5] }}>
  <Styled.small>
    <Styled.span>
      Photo by{' '}
      <Styled.a href="https://unsplash.com/@billy_pasco?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">
        Billy Pasco
      </Styled.a>{' '}
      on{' '}
      <Styled.a href="https://unsplash.com/?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">
        Unsplash
      </Styled.a>
    </Styled.span>
  </Styled.small>
