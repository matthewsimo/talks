...
- <Styled.a href="#expectations">Set expectations</Styled.a>
- <Styled.a href="#timers">Set timers/reminders
- <Styled.a href="#work-space">Create dedicated work space</Styled.a>
- <Styled.a href="#commute">Don't forget to commute</Styled.a>
...
1. Get out of bed
2. Bathroom stuff
3. <Styled.a href="https://www.stumptowncoffee.com/brew-guides/v60">
     Make coffee "the long way"
   </Styled.a> & eat breakfast
...
<Box sx={{ paddingTop: [3, 4, 5] }}>
  <Styled.small>
    <Styled.span>
      Photo by{' '}
      <Styled.a href="https://unsplash.com/@ralics?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">
        Christopher Rusev
      </Styled.a>{' '}
      on{' '}
      <Styled.a href="https://unsplash.com/s/photos/balance?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">
        Unsplash
      </Styled.a>
    </Styled.span>
  </Styled.small>
